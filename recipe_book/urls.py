...
urlpatterns = [
    ...
    path(
        ...
        views.add_remove_favourite,
        name='add_remove_favourite'
        ),
    path(
        'add-update-rating/',
        views.add_update_rating,
        name='add_update_rating'
        ),
    path('delete-rating/', views.delete_rating, name='delete_rating'),
]
